			...
			<div class="select">
				...
				<ul id="accordion" class="accordion">
					...
					<li>
						...
						<ul class="submenu">
							<li><a  href="<%=path%>/CourseServlet">查看所有课程</a></li>
							<li><a href="<%=path%>/insert.jsp">新增课程信息</a></li>
							<li><a href="<%=path%>/delete.jsp">删除课程信息</a></li>
							<li><a href="<%=path%>/update.jsp">修改课程信息</a></li>
